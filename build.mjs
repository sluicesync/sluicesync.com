...
${cmd(
  ...
  <tr><td><code>--restart</code></td><td class="desc">Discard the stored resume cursor for this exact spec (<code>--set</code>/<code>--where</code>) and start over from the beginning of the table.</td></tr>
...
${cmd(
  ...
  <tr><td><code>--deploy-timeout</code></td><td class="desc">Per-deploy-request deadline. Default <code>1h</code> — large tables deploy via VReplication: real wall-clock, but async and unbounded by errno 3024.</td></tr>
  </tbody></table>
...
${cmd(
  ...
  <tr><td><code>--poll-interval</code></td><td class="desc">Deploy-request / branch state polling cadence. Default <code>10s</code>.</td></tr>
  <tr><td><code>--deploy-timeout</code></td><td class="desc">Deploy-request deadline. Default <code>1h</code> (large tables deploy via VReplication — async, unbounded by errno 3024).</td></tr>
  </tbody></table>
